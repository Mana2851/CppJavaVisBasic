Public Class CardFlipper
    ...
    Private changeIncrement As Integer = 10
    ...
    Public Function howLongToWait()
        Return (shrinkTimer.Interval * initWidth) / changeIncrement + (growTimer.Interval * initWidth) / changeIncrement
    End Function

    Public Function isItFlipping()
        Return isFlipping
    End Function
    ...
    Private Sub shrinkABit()
        ...
        button.Width -= changeIncrement
        button.Height -= changeIncrement
